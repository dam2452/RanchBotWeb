...
class AdjustedVideoService:
    ...
    def get_cached(self, clip_index: int, left_adjust: int, right_adjust: int) -> Optional[bytes]:
    ...
    def save_to_cache(self, clip_index: int, left_adjust: int, right_adjust: int, data: bytes) -> None:
