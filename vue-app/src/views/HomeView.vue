...
<template>
  ...
  <main class="flex items-center justify-between w-full min-h-screen p-10 box-border relative max-w-1600px mx-auto max-[1199px]:flex-col max-[1199px]:justify-center max-[850px]:mt-0 max-[850px]:text-center max-[850px]:p-[20px_15px] max-[850px]:gap-[15px] max-[480px]:!p-[10px_8px] max-[480px]:!gap-[8px] min-[1200px]:flex-row min-[1200px]:gap-[60px]">
    ...
    <div class="hidden min-[1200px]:block absolute top-1/2 -translate-y-1/2 w-[27px] z-10 transition-all duration-400 max-[1199px]:!static max-[1199px]:!block max-[1199px]:!transform-none max-[1199px]:!m-[20px_auto] max-[1199px]:!w-[60px] max-[1199px]:order-2 max-[480px]:!m-[10px_auto]" style="left: calc(50% - 150px);">
      <img src="/images/ui/icons/arrow.svg" class="w-[27px] transition-all duration-400 arrow-animate max-[1199px]:!w-[60px] max-[1199px]:!rotate-90 max-[1199px]:!animate-bounce-rotated" alt="Arrow" />
    </div>
